...
void CFilterDialogBar::InitDialogBar() 
{
    ...
    SetWindowLongPtr(m_EDIncludeEdit.m_hWnd,GWLP_USERDATA,(LONG_PTR)this);
    SetWindowLongPtr(m_EDIncludeEdit.m_hWnd,GWLP_WNDPROC,(LONG_PTR)InstantEditProc);

    m_OldExcludeEditProc=(WNDPROC)GetWindowLongPtr (m_EDExcludeEdit.m_hWnd, GWLP_WNDPROC);
    SetWindowLongPtr(m_EDExcludeEdit.m_hWnd,GWLP_USERDATA,(LONG_PTR)this);
    SetWindowLongPtr(m_EDExcludeEdit.m_hWnd,GWLP_WNDPROC,(LONG_PTR)InstantEditProc);
